...
**A phase is run by a program if `pipes/<pipeline><N>.sh` exists, and by an agent if
...
**This phase is a program: `pipes/slim0.sh`, 33 seconds against the 2 m 57 s
...
**This phase is a program: `pipes/slim1.sh`, 17 seconds against 17 minutes.**
...
**This phase is a program: `pipes/slim2.sh`, 5 seconds against 7 m 13 s.** It
...
**This phase is a program: `pipes/slim3.sh`, 1 second against 7 minutes.** It
...
**This phase is a program: `pipes/slim4.sh`, 63 seconds against 5 m 41 s.**
...
**This phase is a program: `pipes/slim5.sh`, 8 seconds against 7 minutes.**
...
**This phase is a program: `pipes/slim7.sh`, 39 seconds against 5 m 24 s.** It
...
**This phase is a program: `pipes/slim9.sh`, 34 seconds against 943.** Delete
