#!/bin/sh
# Pure phase 32 -- :command, user-defined commands.  See PURE-GOAL.md.
#
# Usage: tools/pure32.sh <work-dir>      (run from the repository root)
#
...
work=${1:?usage: pure32.sh <work-dir>}
f="$work/pure-vim.c"
