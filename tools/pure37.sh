#!/bin/sh
# Pure phase 37 -- nothing in the file is unreachable, at the tip.
# See PURE-GOAL.md.
#
# Usage: tools/pure37.sh <work-dir>      (run from the repository root)
#
...
tools/unreachable.sh "${1:?usage: pure37.sh <work-dir>}" \
