#!/bin/sh
# Whim phase 30 -- `[[=a=]]` stops meaning "a with any accent".  See WHIM-GOAL.md.
#
# Usage: tools/whim30.sh <work-dir>      (run from the repository root)
#
...
work=${1:?usage: whim30.sh <work-dir>}
f="$work/whim-vim.c"
