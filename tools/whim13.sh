#!/bin/sh
# Whim phase 7 -- nothing is written that was not asked for.  See WHIM-GOAL.md.
#
# Usage: tools/whim13.sh <work-dir>      (run from the repository root)
#
...
work=${1:?usage: whim15.sh <work-dir>}
f="$work/whim-vim.c"
