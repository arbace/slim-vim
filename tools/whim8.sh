#!/bin/sh
# Whim phase 8 -- the editor stops writing shell scripts, and stops drawing a
# completion menu.  See WHIM-GOAL.md.
#
# Usage: tools/whim8.sh <work-dir>      (run from the repository root)
#
...
work=${1:?usage: whim10.sh <work-dir>}
f="$work/whim-vim.c"
