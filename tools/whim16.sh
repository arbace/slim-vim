#!/bin/sh
# Whim phase 8 -- a file name means the file of that name.  See WHIM-GOAL.md.
#
# Usage: tools/whim16.sh <work-dir>      (run from the repository root)
#
# 'path' searching is the last of the three ways this editor knew where files
# live, after globbing (Phase 7) and 'tags' (Phase 8).  vim_findfile() walks a
