#!/bin/sh
# Whim phase 7 -- the editor stops asking the environment what language it is
# in.  See WHIM-GOAL.md.
#
# Usage: tools/whim11.sh <work-dir>      (run from the repository root)
#
...
work=${1:?usage: whim13.sh <work-dir>}
f="$work/whim-vim.c"
