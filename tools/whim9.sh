...
#
# Usage: tools/whim9.sh <work-dir>      (run from the repository root)
#
# Two things go, and they are the same thing seen from two sides: the editor
# asking the filesystem what is around it.
#
# WILDCARDS.  Phase 8 removed the expander that wrote shell scripts; this
...
work=${1:?usage: whim11.sh <work-dir>}
f="$work/whim-vim.c"
