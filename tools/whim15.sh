#!/bin/sh
# Whim phase 7 -- the editor stops re-reading a file it has already read.
# See WHIM-GOAL.md.
#
# Usage: tools/whim15.sh <work-dir>      (run from the repository root)
#
...
#
# That is the editor initiating filesystem traffic on its own account.  Phase 7
