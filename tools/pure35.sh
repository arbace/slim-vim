#!/bin/sh
# Pure phase 35 -- insert completion and the popup menu.  See PURE-GOAL.md.
#
# Usage: tools/pure35.sh <work-dir>      (run from the repository root)
#
...
work=${1:?usage: pure35.sh <work-dir>}
f="$work/pure-vim.c"
